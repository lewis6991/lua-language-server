...
local function isValidFunction(source)
  ...
  if parent.type ~= 'local' and parent.type ~= 'setlocal' then
    return false
  end
...
return function(uri, callback)
  ...
  local tagSupports =
    client.getAbility('textDocument.completion.completionItem.tagSupport.valueSet')
  local supportUnnecessary = tagSupports
    and util.arrayHas(tagSupports, define.DiagnosticTag.Unnecessary)
