...
---@return string
function fsPath:string() end

---@return fs.path
function fsPath:parent_path() end

---@return boolean
function fsPath:is_relative() end

---@return fs.path
function fsPath:filename() end

---@return fs.path
function fsPath:stem() end

---@return string
function fsPath:extension() end

---@class fs.status
local fsStatus = {}

---@return 'none' | 'not_found' | 'regular' | 'directory' | 'symlink' | 'block' | 'character' | 'fifo' | 'junction' | 'unknown'
function fsStatus:type() end
...
---@return fs.path
function fs.path(path) end

---@return fs.path
function fs.exe_path() end
...
---@param path fs.path
---@return fs.status
function fs.symlink_status(path) end
...
function fs.copy_file(source, target, options) end
